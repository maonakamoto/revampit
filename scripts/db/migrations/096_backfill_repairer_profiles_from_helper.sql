...
-- No-op on fresh DBs where 073 already dropped helper_profiles.

DO $$
BEGIN
  IF to_regclass('public.helper_profiles') IS NOT NULL
     AND to_regclass('public.repairer_profiles') IS NOT NULL THEN
