  ...
  getWelcomeMessage(currentPage: string, language: Language): ChatbotResponse {
    const welcomeMessages: Record<Language, Record<string, string>> = {
      de: {
        ...
        '/services': 'Sie schauen sich unsere Dienstleistungen an! Perfekt - ich kann Ihnen helfen, den passenden Service zu finden.',
        '/about': 'Möchten Sie mehr über unsere Mission erfahren? Ich helfe Ihnen gerne bei der Orientierung.',
        '/projects': 'Unsere Projekte sind wirklich spannend! Lassen Sie mich Ihnen zeigen, was für Sie interessant sein könnte.',
        '/get-involved': 'Fantastisch, dass Sie sich engagieren möchten! Wie können Sie am besten bei RevampIT mitmachen?',
        '/contact': 'Sie möchten mit uns in Kontakt treten? Perfekt - ich helfe Ihnen gerne dabei!'
      },
      en: {
        ...
        '/services': 'You\'re exploring our services! Perfect - I can help you find the right service for your needs.',
        '/about': 'Want to learn more about our mission? I\'m happy to help you navigate.',
        '/projects': 'Our projects are really exciting! Let me show you what might interest you most.',
        '/get-involved': 'Fantastic that you want to get involved! How can you best participate with RevampIT?',
        '/contact': 'Looking to get in touch with us? Perfect - I\'m happy to help!'
      }
    }

    const content = welcomeMessages[language][currentPage] || welcomeMessages[language]['default']
