...
import { ChatbotResponse, ConversationContext, Language, NavigationSuggestion } from '../types'
import { createEnhancedSuggestions } from '../utils/SuggestionEnhancer'
...
export class IntelligentResponder {
  ...
  private buildResponseFromPattern(
    ...
    let content = pattern.responses[language] || pattern.responses['de'] || pattern.responses['en']
    ...
    return {
      ...
      followUp: pattern.followUp?.[language]
    }
  }
