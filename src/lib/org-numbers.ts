/**
 * Organizational Numbers — SSOT Data Layer
 *
 * Provides access to reconciled organizational numbers stored in the
 ...
 * For static/build-time: use ORG_NUMBERS_DEFAULTS (compiled-in fallbacks)
 * For client-side: use /api/org-numbers endpoint
 *
...
function mapRow(row: Record<string, unknown>): OrgNumber {
  return {
    ...
    confidence: row.confidence as OrgNumberConfidence,
...
// ============================================================================
// Static defaults (for SSG/build-time and fallback)
// ============================================================================
