...
export const DESIGN_TOKENS = {
  ...
  iconBadges: {
    ...
    workshops: { bg: 'bg-warning-100', text: 'text-warning-600' },
  ...
  buttons: {
    primary: {
      ...
      workshops: 'bg-warning-600 hover:bg-warning-500',
    ...
    secondary: {
      ...
      workshops: 'border-warning-300 text-warning-700 hover:bg-warning-50',
  ...
  focusOutline: {
    ...
    workshops: 'focus-visible:outline-warning-600',
  ...
  cards: {
    ...
    hoverText: {
      ...
      workshops: 'group-hover:text-warning-600',
