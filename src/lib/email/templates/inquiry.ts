  ...
  return {
    ...
    html: createEmailLayout(
      ...
      <table style="width:100%; border-collapse:collapse; margin:20px 0;">
        <tr><td style="padding:8px; font-weight:bold; width:120px;">Thema</td><td style="padding:8px;">${eTopic}</td></tr>
        <tr style="background:#f3f4f6;"><td style="padding:8px; font-weight:bold;">Name</td><td style="padding:8px;">${eName}</td></tr>
...
export const inquiryConfirmation = (
  ...
  return {
    ...
    html: createEmailLayout(
      ...
      `
      <p>Hallo ${eName},</p>
      <p>vielen Dank für dein Interesse an <strong>${eTopic}</strong> bei ${ORG.name}!</p>
