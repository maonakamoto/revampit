  ...
  getWelcomeMessage(currentPage: string, language: Language): ChatbotResponse {
    const welcomeMessages: Record<Language, Record<string, string>> = {
      de: {
        ...
        '/workshops': 'Interessieren Sie sich für unsere Workshops? Großartig - Bildung ist der Schlüssel zur nachhaltigen IT!',
        ...
        '/get-involved/partnerships': 'Sie denken über eine Partnerschaft nach? Großartig - gemeinsam können wir mehr erreichen!',
