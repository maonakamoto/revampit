...
export default getRequestConfig(async ({ requestLocale }) => {
  ...
  //   2. NEXT_LOCALE cookie  — what next-intl + LocaleSwitcher write when
  //      the user picks or visits a locale; persists across /auth/*, /admin/*
  //      and other BYPASS_INTL routes where there is no URL locale
