...
import { useSuggestionContext } from '@/contexts'
import Link from 'next/link'
import { uiEvents } from '@/lib/ui/uiEvents'

// Import modular components and hooks
import { SuggestionTextarea, FeedbackScopeSelector, QuickSuggestions } from '@/features/feedback/components'
import { useSuggestionForm, useElementSelection } from '@/features/feedback/hooks'
...
export default function SuggestionButton() {
  ...
  // Coordinate with Chat: close suggestions when chat opens
  useEffect(() => {
    const offOpenChat = uiEvents.on('openChat', () => {
      if (isExpanded) {
        closePanelAndReset()
      }
    })
