...
export function WorkshopLoginPrompt() {
  ...
  return (
    <div>
      <Heading level={3} className="text-lg font-semibold text-text-primary mb-4">{t('loginHeading')}</Heading>

      <div className="bg-surface-raised border rounded-lg p-4 mb-4">
        <div className="flex items-center text-text-primary mb-2">
