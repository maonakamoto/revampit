...
// Content is managed through markdown files in /content/projects/

interface TinaProjectProps {
  filename: string
  children?: React.ReactNode
}

export default function TinaProject({ filename, children }: TinaProjectProps) {
  // For now, show a message about content management
  return (
    <div className="container mx-auto px-4 py-8">
      <article className="prose prose-lg max-w-none">
        <header className="mb-8">
          <h1 className="text-4xl font-bold mb-4">Project Content Management</h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            This project content is managed through markdown files in the <code>/content/projects/</code> directory.
          </p>
        </header>
        ...
        <div className="prose-headings:font-semibold prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline">
          <p>
            <strong>To edit this project:</strong>
          </p>
          <ol>
            <li>Edit the markdown file: <code>/content/projects/{filename}</code></li>
