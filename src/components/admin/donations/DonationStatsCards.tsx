...
export function DonationStatsCards({ stats }: Props) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
      ...
      <div className="bg-surface-base rounded-lg shadow-sm p-4 border-l-4 border-neutral-400">
      ...
      <div className="bg-surface-base rounded-lg shadow-sm p-4 border-l-4 border-warning-500">
      ...
      <div className="bg-surface-base rounded-lg shadow-sm p-4 border-l-4 border-secondary-500">
