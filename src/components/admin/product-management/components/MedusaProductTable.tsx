...
import { Package, Eye, Edit, Trash2, Image as ImageIcon, DollarSign, Tag, Store, Users } from 'lucide-react'
import { cn } from '@/lib/utils'
import type { ProductWithOwner } from '../types'

interface MedusaProductTableProps {
...
export function MedusaProductTable({
  products,
  selectedProducts,
  onSelectAll,
  onSelectProduct,
}: MedusaProductTableProps) {
  return (
