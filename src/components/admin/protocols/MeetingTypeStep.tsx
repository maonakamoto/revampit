...
export function MeetingTypeStep({ selectedType, onSelect, onReset }: Props) {
  ...
  return (
    <div className="space-y-4">
      <Heading level={2} className="text-lg text-neutral-900">Besprechungstyp wählen</Heading>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-neutral-900">{MEETING_TYPE_LABELS[type]}</span>
                </div>
                <span className="text-sm text-neutral-500">{template.typical_duration}</span>
              </div>
