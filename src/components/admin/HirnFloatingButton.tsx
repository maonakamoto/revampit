  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-full mr-3 px-3 py-1.5 bg-surface-overlay text-text-primary text-sm rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          {t('label')}
        </span>
      </Button>
