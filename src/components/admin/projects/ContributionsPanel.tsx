...
const STATUS_BADGE: Record<ContributionStatus, string> = {
  ...
  declined:  'bg-neutral-100 text-neutral-700 dark:bg-white/[0.06] dark:text-neutral-400',
}
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-3">
          {filtered.map(c => {
            ...
            return (
              <div key={c.id} className="rounded-lg border border-neutral-200 dark:border-white/[0.08] p-3 sm:p-4">
                <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                  ...
                  <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs text-neutral-500 dark:text-neutral-400 w-full sm:w-auto">
                ...
                <div className="rounded bg-neutral-50 dark:bg-white/[0.03] border border-neutral-100 dark:border-white/[0.04] p-3 text-sm text-neutral-700 dark:text-neutral-300 whitespace-pre-wrap mb-3 break-words">
                  {c.message}
                </div>
