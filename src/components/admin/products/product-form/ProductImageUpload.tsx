...
export function ProductImageUpload({ imagePreviews, onImageUpload, onRemoveImage }: Props) {
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-100 dark:border-neutral-700 p-6">
      <Heading level={2} className="text-lg text-neutral-900 dark:text-white mb-6">Produktbilder</Heading>
        ...
        <div className="border-2 border-dashed border-neutral-300 dark:border-neutral-600 rounded-lg p-8 text-center">
          ...
          <div className="text-sm text-neutral-600 dark:text-neutral-400">
            <label htmlFor="product-image-upload" className="cursor-pointer">
              <span className="font-medium text-primary-600 hover:text-primary-500">Dateien auswählen</span>
          ...
          <p className="text-xs text-neutral-500 mt-2">PNG, JPG, GIF bis zu 10MB</p>
        </div>
