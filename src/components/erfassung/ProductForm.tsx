  ...
  return (
    <>
      ...
      <button
        ...
        className="sm:hidden w-full flex items-center justify-between px-4 py-3 bg-neutral-100 dark:bg-neutral-700 rounded-xl text-neutral-700 dark:text-neutral-300 touch-manipulation"
      >
