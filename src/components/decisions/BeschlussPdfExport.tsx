...
export default function BeschlussPdfExport({ decision }: { decision: DecisionForExport }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-md border border-neutral-300 bg-surface-base px-3 py-1.5 text-sm font-medium text-text-secondary hover:bg-surface-raised transition-colors"
    >
