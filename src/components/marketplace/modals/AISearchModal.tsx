      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:border dark:border-white/[0.06] rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden"
                  ...
                  <div className="flex flex-wrap gap-2">
                    {searchExamples.map((example) => (
                      <button
                        ...
                        className="px-3 py-1 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full text-xs hover:bg-primary-200 dark:hover:bg-primary-900/40 transition-colors min-h-[touch] touch-target"
                      >
                        {example}
                      </button>
                    ))}
                    ...
                    {searchResults.map((result) => {
                      ...
                      return (
                        <div
                          ...
                          className="p-4 border-2 border-neutral-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 cursor-pointer transition-colors"
                        >
