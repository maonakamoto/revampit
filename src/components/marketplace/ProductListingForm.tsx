...
export default function ProductListingForm() {
  ...
  const handleSelectSearchResult = (result: Parameters<typeof selectResult>[0]) => {
    const updates = selectResult(result)
    Object.entries(updates).forEach(([key, value]) => {
      updateField(key as keyof ProductFormData, value as string)
    })
