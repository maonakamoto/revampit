 ...
 *
 * Centralized configuration for all RevampIT projects.
 * SSOT for project data, categories, and metadata.
 */

import { Code, Globe, CheckCircle2, Users, Wrench, LucideIcon } from 'lucide-react'
...
export type ProjectCategory = 'Software-Projekte' | 'Hardware-Projekte' | 'Community-Projekte'
export type ProjectStatus = 'Aktiv' | 'Laufend' | 'Abgeschlossen'
...
export const CATEGORY_FILTER_OPTIONS = ['Alle', ...PROJECT_CATEGORIES] as const

// Helper Functions
export function getProjectsByCategory(category: ProjectCategory | 'Alle'): Project[] {
  if (category === 'Alle') {
    return PROJECTS
  }
...
export function getUniqueCategories(): string[] {
  return ['Alle', ...PROJECT_CATEGORIES]
}
...
export const PROJECTS_PAGE_CONFIG = {
  hero: {
    ...
    description: 'Entdecken Sie unsere Open-Source-Projekte und Community-Initiativen'
  },
  filter: {
