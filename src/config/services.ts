 ...
 *
 * Centralized configuration for all RevampIT services.
 * SSOT for service offerings, pricing, and categories.
 */
...
export const SERVICES: Service[] = [
  // Hardware Services
  {
    ...
    pricing: 'CHF 70/Stunde + Teile',
    highlight: 'Professionelle Bewertung erforderlich',
  ...
  },
  {
    ...
    highlight: 'Bewertung vor Wiederherstellung erforderlich',
  ...
  },
  {
    ...
    pricing: 'Kostenlos für die meisten Artikel',
    highlight: 'Kostenloser Abholservice verfügbar',
  ...
  // Software Solutions
  {
    ...
    pricing: 'CHF 70/Stunde',
    highlight: 'Kostenlose Erstberatung',
...
export const CATEGORY_FILTER_OPTIONS = ['Alle', ...SERVICE_CATEGORIES] as const

// Helper Functions
export function getServicesByCategory(category: ServiceCategory | 'Alle'): Service[] {
  if (category === 'Alle') {
    return SERVICES
  }
...
export const SERVICES_PAGE_CONFIG = {
  hero: {
    ...
    description: 'Professionelle IT-Dienstleistungen mit Fokus auf Nachhaltigkeit und Open-Source'
  },
  filter: {
    label: 'Dienstleistungen filtern',
    allLabel: 'Alle Dienstleistungen'
  },
  pricing: {
    standardRate: 'CHF 70/Stunde',
    currencySymbol: 'CHF'
  }
} as const
