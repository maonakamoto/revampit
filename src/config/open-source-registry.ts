...
export const MATURITY_CONFIG: Record<Maturity, { label: string; color: string }> = {
  established: { label: 'Etabliert', color: 'bg-green-100 text-green-800' },
...
export const MIGRATION_DIFFICULTY_CONFIG: Record<MigrationDifficulty, { label: string; color: string; description: string }> = {
  easy: { label: 'Einfach', color: 'bg-green-100 text-green-800', description: 'Direkter Umstieg, kaum Einarbeitung nötig' },
...
export const OSS_ALTERNATIVES: OSSAlternative[] = [
  ...
  // ===== CLOUD & FILES =====
  {
    ...
    description: 'Nextcloud ist die führende selbstgehostete Cloud-Lösung: Dateisynchronisation, Kalender, Kontakte, E-Mail, Videokonferenzen, Office-Integration und hunderte Apps. Volle Kontrolle über Ihre Daten auf Ihrem eigenen Server.',
    categoryId: 'cloud',
    ...
    highlights: ['Komplette Cloud-Plattform (Dateien, Kalender, Kontakte, Office)', 'Volle Datenkontrolle — Ihre Daten bleiben bei Ihnen', 'Hunderte Erweiterungen verfügbar', 'Schweizer Hosting-Anbieter verfügbar', 'DSGVO-konform'],
    ...
    revampitServices: { itHilfeNote: 'Wir richten Nextcloud für Sie ein und helfen bei der Migration' },
  },
  {
    id: 'syncthing',
    name: 'Syncthing',
