                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-600 mb-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>Beantragt am {formatDate(appointment.created_at)}</span>
                        </div>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getUrgencyColor(appointment.urgency)}`}>
                          {appointment.urgency === 'high' ? 'Hoch' : appointment.urgency === 'normal' ? 'Normal' : 'Niedrig'}
                        </span>
                      </div>
                ...
                {appointment.status === 'requested' && (
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-center text-yellow-800">
                      ...
                      <span className="font-medium">Terminanfrage ausstehend</span>
                    </div>
                ...
                {appointment.status === 'completed' && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-center text-blue-800">
                      <CheckCircle className="w-5 h-5 mr-2" />
                      <span className="font-medium">Dienstleistung abgeschlossen</span>
                    </div>
                    {appointment.outcome_notes && (
                      <p className="text-blue-700 text-sm mt-1">{appointment.outcome_notes}</p>
                    )}
                  </div>
                )}
