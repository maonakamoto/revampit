 ...
 *
 * Tests for POST /api/admin/intake/extract-text
 *
 * Behaviors locked:
 *   POST - 401, 400 (no text), 400 (too short), 200
 */
...
function makeRequest(body?: Record<string, unknown>) {
  return new NextRequest('http://localhost/api/admin/intake/extract-text', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(body ?? { text: 'Dell Latitude E7470 Laptop i7 8GB RAM' }),
  })
}
...
describe('POST /api/admin/intake/extract-text — unauthenticated', () => {
...
describe('POST /api/admin/intake/extract-text — validation', () => {
...
describe('POST /api/admin/intake/extract-text — success', () => {
