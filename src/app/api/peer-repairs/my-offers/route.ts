...
export async function GET(request: NextRequest) {
  try {
    ...
    const offersResult = await query(`
      ...
      JOIN ${TABLE_NAMES.PEER_REPAIR_REQUESTS} r ON o.request_id = r.id
    ...
    logger.info('Fetched user peer repair offers', {
    ...
    logger.error('Error fetching user peer repair offers', { error })
