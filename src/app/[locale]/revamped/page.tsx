          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">{t('stickers.sticker1.body')}</p>
              </div>
              <div className="text-center">
                <div className="bg-white p-12 rounded-2xl shadow-lg mb-6">
                  <Image
                ...
                <p className="text-gray-600">{t('stickers.sticker2.body')}</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">{t('stickers.sticker3.body')}</p>
              </div>
            </div>
          </div>
        </div>
