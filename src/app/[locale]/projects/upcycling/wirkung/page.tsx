...
/* ─── 1. Environment ────────────────────────────────────────────── */
/* Three top-line metrics with their source cited immediately below.
 * Honest caveat anchored to the ZHAW work; link to /transparenz/co2
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <p className="mt-8 max-w-3xl text-sm leading-relaxed text-text-secondary">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-action underline-offset-2 hover:underline"
          >
            {section.transparencyLink}
    ...
    >
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-action hover:underline underline-offset-2"
        >
