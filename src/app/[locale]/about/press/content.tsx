        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap justify-center gap-8 sm:gap-16">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-1">{t('stats.mediaMentions')}</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-green-600">{stats.uniqueSources}</p>
              <p className="text-sm text-gray-500 mt-1">{t('stats.uniqueSources')}</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold text-green-600">{stats.partnerships}</p>
              <p className="text-sm text-gray-500 mt-1">{t('stats.partnerships')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <Heading level={2} className="text-xl text-gray-900">{t('nationalMedia')}</Heading>
            <Star className="h-5 w-5 text-amber-500" />
          </div>
