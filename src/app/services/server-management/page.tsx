    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <PageHero
          ...
          subtitle="Zukunftsvision: Ethisches Infrastruktur-Management. Als missionsgetriebene gemeinnützige Organisation stellen wir uns vor, Server-Management-Dienstleistungen anzubieten, die die Bedürfnisse der Gemeinschaft und die ökologische Verantwortung in den Vordergrund stellen."
        >
          <div className="mt-6 space-y-4 max-w-3xl mx-auto">
            ...
            <div className="bg-white/90 border border-red-200 rounded-lg p-4">
              <p className="text-gray-700 text-sm">
                <strong>Dieser Service ist derzeit nicht verfügbar.</strong> Dies repräsentiert unsere langfristige Vision zur nachhaltigen Unterstützung der Technologieinfrastruktur der Gemeinschaft.
              </p>
            </div>
            ...
            <div className="bg-white/90 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 text-sm">
                  <strong>Visions-Zeitplan: 2026-2028</strong> - Durch sorgfältigen Kapazitätsaufbau und Gemeinschaftspartnerschaften streben wir an, ethisches Server-Management anzubieten.
                </p>
              </div>
            </div>
          </div>
