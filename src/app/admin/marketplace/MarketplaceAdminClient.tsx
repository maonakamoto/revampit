    ...
    <div className="space-y-6">
      ...
      {m.stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatsCard label="RevampIT" value={m.stats.revampit} icon={Store} color="bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800 text-purple-800 dark:text-purple-200" />
        </div>
      )}
