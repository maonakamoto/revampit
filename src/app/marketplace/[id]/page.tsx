      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm space-y-3">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-gray-500 dark:text-gray-400 flex items-center gap-1">
                <Truck className="w-3.5 h-3.5" /> Lieferung
              </span>
                ...
                {messageSent ? (
                  <div className="w-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 text-center space-y-2">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 text-sm text-green-600 hover:text-green-700 font-medium underline"
                    >
                  ...
                  <div className="w-full space-y-3">
                    <textarea
                      ...
                      rows={4}
                      className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                    />
                    <div className="flex gap-2">
                      <button
                        onClick={sendMessage}
                        disabled={sendingMessage || !contactMessage.trim()}
                        className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white py-2.5 px-4 rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      >
                        {sendingMessage ? (
                      ...
                      <button
                        ...
                        className="py-2.5 px-4 rounded-lg font-medium border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                      >
                        Abbrechen
                      </button>
                    </div>
            ...
            <div className="flex gap-3">
              {session?.user && (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium border transition-colors ${
                    isFavorited
              ...
              {isOwner && (
                <Link
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg font-medium border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                >
                  Bearbeiten
                </Link>
              )}
          ...
          <Link
            ...
            className="block bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm hover:shadow-md hover:ring-1 hover:ring-green-200 dark:hover:ring-green-800 transition-all"
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {listing.is_revampit && <Shield className="w-4 h-4 text-blue-500" />}
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                  ...
                  {listing.seller_city && (
                    <span className="flex items-center gap-0.5">
                      <MapPin className="w-3 h-3" /> {listing.seller_city}
                    </span>
                  )}
                </div>
              </div>
