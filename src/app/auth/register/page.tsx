...
export const metadata: Metadata = {
  title: 'Registrieren | RevampIT',
  description: 'Erstellen Sie ein RevampIT-Konto, um sich für Workshops anzumelden, Termine zu buchen und Teil unserer Community zu werden.',
}
