...
En la primera parte, [«La segunda vida de una tableta»](/blog/tablets-second-life), aclaramos lo esencial: casi ninguna tableta en el cajón está rota. La abandonó su software — y con un sistema operativo libre y una única tarea fija puede seguir funcionando durante años. «Dale una nueva tarea al aparato viejo», decíamos. Esa era la teoría.
...
1. **Los aparatos.** Tabletas donadas que de todos modos acaban con nosotros.
2. **El reacondicionamiento.** Reparación, cambio de batería y reflash son nuestro oficio central y nuestro Repair Café.
3. **El saber hacer del quiosco.** El camino del aparato viejo al terminal de un solo uso bloqueado — documentado en la primera parte.
4. **El software.** Cada vez más nuestra propia plataforma, que aporta la tarea.
...
1. **Elegir una tarea.** Una, y solo una — reloj de fichar, registro, catálogo, inscripción.
2. **Colocar el aparato.** Donde haya corriente. Los terminales fijos quedan enchufados, así una batería débil no es problema.
3. **En uso en red, instalar un SO libre.** LineageOS o /e/OS, para que el aparato siga seguro y actualizado sin bloqueo del fabricante.
4. **Bloquear en la única aplicación.** Configurar el modo quiosco — fijación de pantalla, app de quiosco o Acceso guiado. Después la tableta solo muestra esta interfaz.
5. **Ponerlo en la wifi de invitados o IoT** y apagar las cuentas y sensores no usados.
...
- RevampIT — [«La segunda vida de una tableta»](/blog/tablets-second-life): por qué las tabletas «mueren», los sistemas libres y el modo quiosco en detalle.
- RevampIT — [Cálculo de CO₂ y fuentes](/transparenz/co2): nuestro modelo abierto y con fuentes de la huella de fabricación por categoría de aparato (basado en los datos abiertos de la ADEME).
- UNITAR & ITU — [Global E-waste Monitor 2024](https://ewastemonitor.info/the-global-e-waste-monitor-2024/): 62 Mt de residuos electrónicos, 22,3 % reciclados de forma documentada.
