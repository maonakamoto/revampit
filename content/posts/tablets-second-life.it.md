---
title: "La seconda vita di un tablet"
excerpt: "La maggior parte dei tablet «rotti» non è affatto rotta — è solo il loro software a essere stato abbandonato. Perché il riutilizzo conviene, cosa può ancora fare un vecchio tablet e quali sistemi operativi open source gli regalano anni."
...
![Rifiuti elettronici globali dal 2010 al 2030: 34, 62 e un previsto 82 milioni di tonnellate — solo il 22,3 per cento del volume del 2022 è stato riciclato.](/blog/tablets-ewaste.svg)
...
![Ripartizione dell'impronta di 95 kg CO₂e di un iPad mini: 66 kg produzione, 21 kg utilizzo, 6 kg trasporto, 2 kg riciclo.](/blog/tablets-co2.svg)
...
| Sistema | Base | Ideale per | Impegno |
| --- | --- | --- | --- |
| **LineageOS** | Android · AOSP | Supporto dispositivi più ampio, quotidianità affidabile | Basso |
| **/e/OS** | Android · degooglizzato | Privacy senza perdita di comfort | Basso |
| **postmarketOS** | Linux · Alpine | Vero tablet Linux, durata più lunga | Alto |
| **Ubuntu Touch** | Linux · UBports | Linux pulito, simile a un telefono | Medio |
...
- UNITAR & ITU — [Global E-waste Monitor 2024](https://ewastemonitor.info/the-global-e-waste-monitor-2024/) (62 Mt di volume, 22,3 % riciclato, crescita cinque volte più rapida, 82 Mt entro il 2030).
- Apple — [Rapporto ambientale iPad mini](https://www.apple.com/environment/) (95 kg CO₂e nel ciclo di vita; 66 kg ovvero 69 % da materiali e produzione).
- [LineageOS](https://lineageos.org/), [/e/OS](https://e.foundation/), [postmarketOS](https://postmarketos.org/), [Ubuntu Touch (UBports)](https://ubports.com/) — pagine ufficiali dei progetti.
