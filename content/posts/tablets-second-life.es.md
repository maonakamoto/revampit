...
**Por qué esto ayuda al planeta.** Cada uno de estos es un dispositivo nuevo que nunca se compra: una tablet vieja como panel de pared reemplaza una pantalla de hogar inteligente comprada; una pantalla de recetas reemplaza un nuevo aparato de cocina. El cálculo de carbono de más arriba se aplica directamente — aproximadamente dos tercios de la huella de un dispositivo quedan fijados en su fabricación, y te ahorras todo eso cuando una tablet ya existente asume la tarea. Al mismo tiempo, un dispositivo que de otro modo se quedaría en un cajón o en la basura sigue en servicio durante años — y fuera de ese flujo de residuos del 77,7 por ciento. Poco esfuerzo, doble victoria: ningún dispositivo nuevo y nada de basura electrónica.

**Cómo hacer uno — y bloquearlo en modo quiosco.** El camino es corto. Elige el rol y coloca la tablet donde haya corriente — la mayoría se quedan permanentemente enchufadas, así que una batería cansada ya no importa. Opcionalmente instala un sistema operativo ligero y libre (siguiente sección), sobre todo si va a estar conectado a internet, y configura la única app que mostrará de ahora en adelante. El paso decisivo es bloquear el dispositivo exactamente en esa app, para que nadie deambule por los menús ni abra otra cosa por accidente — esto se llama **modo quiosco**. Android trae *fijar pantalla* (screen pinning) integrado; para paneles montados de forma permanente hay apps de quiosco específicas que fijan el dispositivo de manera aún más estricta a un único dashboard web o app. En el iPad la misma función se llama *Acceso Guiado* (Ajustes → Accesibilidad) — justo lo indicado para el dispositivo infantil o la tablet con la última versión soportada de iPadOS de antes. Por último, pon el dispositivo en una WLAN de invitados o de IoT y desactiva las cuentas y los sensores que no necesite. El resultado es un terminal que hace exactamente una cosa, durante años.

**Quién quiere uno.** Más gente de la que crees. Hogares: panel de hogar inteligente, dispositivo de aprendizaje infantil, pantalla de recetas o de fotos. Cafés, tiendas y clínicas: carteles de menú e información (señalización digital, digital signage), terminales de registro y de opiniones, pantallas de colas y de reservas. Escuelas, bibliotecas y makerspaces: estaciones de aprendizaje e información baratas y dedicadas. Cuidados y accesibilidad: un dispositivo bloqueado en una única app de videollamada o de fotos suele ser más usable para personas mayores o personas que necesitan apoyo que una tablet completamente abierta. Para todos estos casos, una tablet reacondicionada en modo quiosco es mucho más barata — y mucho más ecológica — que un hardware de quiosco fabricado a medida. Estos son exactamente los dispositivos que RevampIT puede reacondicionar a partir de donaciones y transmitir.

**¿Puede ser totalmente de código abierto?** En Android: sí, de principio a fin. La base es un sistema operativo libre como LineageOS o /e/OS (siguiente sección), las apps vienen de la tienda de código abierto *F-Droid*, el bloqueo lo gestiona una app de quiosco de código abierto (como *Webview Kiosk* o *WallPanel*), y un dashboard lo sirve el igualmente abierto *Home Assistant*. Sin cuenta de Google, sin tracking, sin cuotas de licencia — ideal para asociaciones, escuelas y cualquiera que quiera control total. Solo el iPad se queda fuera: su bootloader bloqueado no admite ningún sistema operativo libre, así que ahí se queda con *Acceso Guiado* sobre el iPadOS original.
