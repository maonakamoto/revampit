...
INSERT INTO product_attributes (category_id, name, display_name, data_type, unit, is_required, is_filterable, ai_extraction_prompt) VALUES
    ...
    ((SELECT id FROM product_categories WHERE slug = 'electronics'), 'condition', 'Zustand', 'select', NULL, true, true, 'Assess the physical condition of the product', ARRAY['new', 'like_new', 'good', 'fair', 'poor']),
